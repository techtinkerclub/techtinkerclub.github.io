...
layout: single
title: ""
permalink: /curriculum/2025-26/spring/week-2/
week: 2
toc: true
toc_sticky: true
sidebar: false
...
**Mini-Project:** *Stamp or Cookie Cutter (no food use)*
...
This week’s session is hands-on and creative. Participants will complete a **mini-project** — *Stamp or Cookie Cutter (no food use)* — to apply new tools and build confidence.
...
- Practice aligning shapes along axes.
- Group/ungroup; create cut-outs using holes.
