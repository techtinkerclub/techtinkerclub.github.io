...
layout: single
title: ""
permalink: /curriculum/2025-26/spring/week-4/
week: 4
toc: true
toc_sticky: true
sidebar: false
...
This week’s session is hands-on and creative. Participants will complete a **mini-project** — *Symmetric Creature or Rocket* — to apply new tools and build confidence.
...
- Mirror parts across chosen axes.
- Use align + mirror for clean symmetry.
## Part B — Make: Creature/Rocket
- Block out silhouette with basic shapes.
- Mirror limbs/fins and add details.
## Part C — Extend & Share
- Discuss stability in prints (flat base).
- Pose ideas for future upgrades (wheels, slots).
