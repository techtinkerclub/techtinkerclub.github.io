...
layout: single
title: ""
permalink: /curriculum/2025-26/spring/week-3/
week: 3
toc: true
toc_sticky: true
sidebar: false
...
## Week 3 — Measure, Scale, Workplanes

**Focus Concept:** Precision design using ruler, grid, units, and workplanes  
**Mini-Project:** *Mini Box & Peg Fit Test*
...
This week’s session is hands-on and creative. Participants will complete a **mini-project** — *Mini Box & Peg Fit Test* — to apply new tools and build confidence.

---

## Objectives
- Understand and use the week’s core tools in Tinkercad.
- Apply design thinking to make a simple, working model.
...
## Part A — Explore Precision Tools
- Use the ruler and grid settings.
- Add a workplane to edit faces in context.
## Part B — Make: Box & Peg
- Design a box and a matching peg with small clearance.
- Discuss tolerances for printing (teacher demo).
## Part C — Extend & Share
- Annotate sizes and label parts with text.
- Optional: add a simple lid if time allows.
...
- Mice (recommended for easier orbit/pan/zoom)
...
## Safety & Setup Notes
- Supervise slicing/printing; only adults operate printers.
- Avoid overly thin parts that can snap.
- Encourage careful mouse/keyboard use and screen breaks.
