...
function normMobile(raw={}){return {difficulty:DIFFS.includes(raw.difficulty)?raw.difficulty:'standard',layout:['auto','simple','nested','multiple'].includes(raw.layout)?raw.layout:'auto',givenMode:['auto','shape','total'].includes(raw.givenMode)?raw.givenMode:'auto'};}
...
const GRID_STATE_CACHE={3:bitStates(3),4:bitStates(4)};
