/* 99 Club Studio · online game library filters v4.1 */
(function(global){
'use strict';
function boot(){const Play=global.TT99GamesPlay,library=document.getElementById('tt99-play-library'),grid=document.getElementById('tt99-play-library-grid');if(!Play||!library||!grid||library.dataset.filtersV4==='1')return;library.dataset.filtersV4='1';
  const GROUPS=[['all','All'],['arithmetic','Arithmetic'],['number','Number logic'],['visual','Visual logic'],['vocabulary','Vocabulary']],MAP={sumplete:'arithmetic',cornersum:'arithmetic',linkedsum:'arithmetic',killersudoku:'arithmetic',kakuro:'arithmetic',arithmeticcages:'arithmetic',brokencalc:'arithmetic',target:'arithmetic',operationgrid:'arithmetic',alphametics:'number',takuzu:'number',sudoku:'number',futoshiki:'number',numberpath:'number',nonogram:'visual',mathsmines:'visual',hashi:'visual',shikaku:'visual',wordsearch:'vocabulary'};let active='all';
