...
const MODERN_KINDS=new Set(['sumplete','numbertowers','takuzu','killersudoku','hashi','mathsmines','alphametics','balance','cornersum','linkedsum','colourlogic','mobilebalance','diagonalpath','squaresearch','insertops','perimeterregions']);
