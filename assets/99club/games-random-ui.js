/* 99 Club Studio · Random pack UI v1.0.1
...
(function(global){
  ...
  function enhance(){
    ...
    if(currentMode==='random'){
      ...
      const note=document.createElement('p');note.className='tt99-random-pack-note';note.innerHTML='<strong>Random pack:</strong> manual game selections are preserved but temporarily ignored. Switch back to “Use my selected games” at any time.';firstStep?.after(note);
