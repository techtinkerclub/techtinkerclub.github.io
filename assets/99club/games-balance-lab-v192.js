...
function mount(root,p,ctx){
  ...
  function render(){
    ...
    weightBtns.forEach((b,i)=>{b.disabled=finished||!unlocked;b.classList.toggle('is-left',sides[i]==='L');b.classList.toggle('is-right',sides[i]==='R');b.querySelector('span').textContent=sides[i]==='L'?'LEFT':sides[i]==='R'?'RIGHT':'TRAY';});
