...
layout: single
title: ""
permalink: /instructor-notes/2025-26/autumn/week-1-notes/
week: 1
robots: noindex
toc: true
toc_sticky: true
...
## Learning Objectives
- Participants understand what a microcontroller is and its role in everyday devices.  
- Participants can explain the concept of **Input → Process → Output**.  
- Participants can use MakeCode to create a simple program and upload it to a micro:bit.  
- Participants feel welcomed into the club community and understand expectations.  
...
- Participants suggest examples of inputs (buttons, sensors) and outputs (lights, sounds).
...
- Participants program the LEDs to scroll their name.
...
- Support participants in logging in and flashing their first test program.
...
- Cable strain — show participants how to insert/remove gently.  
...
- Note participant confidence levels (especially new members).  
- Record common troubleshooting issues for improvement in Week 2.  
- Identify participants who could mentor peers in future sessions.  
