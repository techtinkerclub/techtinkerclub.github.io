...
<div class="tt99-guide">
  ...
  <section id="games" class="tt99-guide-section tt99-guide-highlight">
    ...
    <p>The separate <a href="/tools/99-club/games/">Games &amp; Puzzles</a> page creates printable independent activities from the same curriculum-minded Studio approach. Current engines are Word Search, Number Pyramid, Crossword, Magic Squares and Mini Sudoku / Latin Squares.</p>
    ...
    <p><strong>Mini Sudoku / Latin Squares</strong> adds a second logic engine. Mini Sudoku uses row, column and outlined-box rules; Latin Squares use rows and columns only. Teachers can choose 4×4 or 6×6 grids, clue density and puzzle style, or leave those options on Auto. Every generated puzzle is checked for a unique solution.</p>
