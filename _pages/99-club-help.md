...
<div class="tt99-guide">
  ...
  <section id="custom" class="tt99-guide-section tt99-guide-highlight">
    ...
    <p><strong>Custom Worksheets starts blank.</strong> No year group and no curriculum topic is selected automatically. Open any curriculum category and tick only the topics you actually want to practise, including generated bar/time/line graphs, Year 6 pie charts and coordinate-geometry families.</p>
    ...
    <p>Bar charts, time graphs, line graphs, Year 6 pie charts and coordinate geometry use generated visual questions with automatic multi-page packing. Other diagram-heavy areas are added only when their dedicated renderer is ready.</p>
  </section>
